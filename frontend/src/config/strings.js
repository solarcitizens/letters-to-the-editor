export const FormValidationErrors = {
  ...
  postCode: { name: 'postCode', message: 'Please enter your postcode.' },
  email: { name: 'email', message: 'Please enter a valid email address i.e. valid@email.com' },
  phone: { name: 'phone', message: 'Please enter a valid phone number.' },
  subject: { name: 'subject', message: 'Please enter a subject for your letter.' },
  body: { name: 'body', message: 'Please write something to put in your letter.' },
};
